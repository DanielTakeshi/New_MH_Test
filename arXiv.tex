...
% \address{ Unknown Institution 1 \And Unknown Institution 2 \And Unknown Institution 3 } ]
...
% well onto hardware such as GPUs. 
...
%means finding a deep posterior mode. 
...
\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{logistic_regression_ll_acc_results.png}
	\caption{
...
%\begin{figure*}[t!]
	\centering
	\includegraphics[width=\linewidth]{logistic_regression_histograms_results.png}
	\caption{
...
than~\citet{icml2014c1_bardenet14}, and almost an order of magnitude faster than the
undiscounted implementation of~\citet{cutting_mh_2014}.
