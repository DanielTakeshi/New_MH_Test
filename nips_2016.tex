...
initialize the temperature $T_0 = 3000$, and decrease it by the rule $T_i =  T_0 /(i + 1)^{3} \mbox{
for } i \leq N/2 \mbox{ and } = T_0 /(i + 1)^{0.2} \mbox{ for } i >N/2 $, where $N=4000$ is
the total number of iterations. If our estimated ${\rm std}(\Delta') \ge 1.2$, we ignore the
