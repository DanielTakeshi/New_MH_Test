...
We use this experiment to illustrate another property of our minibatch MH testing: when the size of
minibatch increase to a threshold, the accuracy / log likelihood of sampled data at a fix iteration
number will not improve with larger minibatch size, see Fig.~4c. This is because the variance of
$\Delta'$ decrease with large minibatch, and the error of our minibatch MH testing is proportional
to our estimation error of variance of $\Delta'$. When the ${\rm Var}(\Delta')$ decrease to a
threshold, the error of our minibatch MH testing can be ignored.
