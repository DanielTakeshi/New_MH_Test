...
\For{$t=\{1, \ldots, T\}$}{
    ...
    Compute the $\Delta'$ from one minibatch data\;
    Compute the ${\rm std}(\Delta')$ from another minibatch data\;
    \While {${\rm std}(d) \ge 1.2$} {
    	Update the value of $\Delta'$ and ${\rm std}(\Delta')$ from one new minibatch\;
    }
