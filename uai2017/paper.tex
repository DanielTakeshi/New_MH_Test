...
log probability ratio between proposal and current state is small
...
simply not enough information in $M << N$ samples to locate and
...
We note that 2 above is characteristic of Gibbs samplers applied to
...
ML problems with multi-model posteriors since they correspond to a finer-scale
random walk through the posterior landscape. 
\begin{comment}
...
\begin{itemize}[noitemsep]
    ...
    \item We compare our new test and prior approaches on several
      ...
      and that batch size distribution is short-tailed. 
\end{itemize}
