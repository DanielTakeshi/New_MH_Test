...
distribution is short-tailed and the mean is 213, more than an order of
magnitude better compared to the other two methods (averages are 11962 and
63408). Sizes correspond to the running times of the methods, excluding the
