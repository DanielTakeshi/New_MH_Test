...
samples $\{\theta_1,\ldots,\theta_T\}$, generally with $T=3000$ or $T=5000$.
...
\begin{figure*}[t]
    ...
    {\sc MHminibatch} on both datasets when the temperature starts at $K=100$
    and drops to $K=1$ after a ``burn-in'' period of 200 samples of $\theta$.
