...
distribution is short-tailed and the mean is 181, more than an order of
magnitude better compared to the other two methods (averages are 13511 and
73011). Sizes correspond to the running times of the methods, excluding the
