...
earlier methods. See Appendix~\ref{app:why_barker} for details.
...
precisely, the CDF error from the closest Gaussian CDF numerically satisfies
$\sup_x |L(x) - \Phi(x/1.7)| < 0.01$, i.e. the sup error between Logistic and
Gaussian CDFs is less than 1\%. With our correction we can make this error
