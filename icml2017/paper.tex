...
% Daniel: also need to modify table, add more info?
\begin{table}[t]
...
Let's state the result (Table~\ref{tab:poissons}) and prioritize other stuff.
TODO}
...
Appendix~\ref{app:experiments} provides further details on our experiments to
assist understanding and reproducibility.
...
% Daniel: all three experiments should be described in more detail here.
