...
for~\citet{cutting_mh_2014} should be treated as lower bounds. All
methods were initialized with minibatch size 100.
For~\citet{cutting_mh_2014} we increment sizes by 100 and set the
tolerance $\epsilon=0.005$ to control overall test error.
For~\citet{icml2014c1_bardenet14}, we increase sizes geometrically
...
as the starting minibatch size. Our undiscounted implementation of~\citet{cutting_mh_2014} used
...
average minibatch size of 393, about two orders of magnitude smaller than
~\citet{icml2014c1_bardenet14}, and an order of magnitude faster than
the undiscounted implementation of~\citet{cutting_mh_2014}.
