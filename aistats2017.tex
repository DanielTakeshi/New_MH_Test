...
purpose of minibatch MCMC. In contrast, we use quantitative forms of the Central
...
% Daniel: don't forget this. The instructions say to put it in the supplementary
% material, so I put it at the very end on a new page (to make it more
% noticeable). Obviously for the arXiv version, we don't want this there.
\newpage
