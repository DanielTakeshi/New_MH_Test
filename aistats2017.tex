...
We first borrow a Gaussian mixture experiment from~\citet{langevin_2011}.  The
...
proportional to the data consumed, with the exception of the
$C_{\theta,\theta'}$ time for~\citet{icml2014c1_bardenet14}.Using minibatch
sizes as a proxy for time also avoids discrepancies due to code optimization.
...
in terms of accuracy, achieving convergence using roughly half as many elements
